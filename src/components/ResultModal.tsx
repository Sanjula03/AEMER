    ...
    return (
        ...
        >
            <div className="min-h-full flex items-start justify-center py-8 px-4">
                {/* Modal card — full content, no max-height, naturally scrollable */}
                <div
                ...
                >
                    ...
                    <div
                        className={`relative bg-gradient-to-r ${getEmotionColor(result.emotion_label)} p-6 text-white text-center rounded-t-2xl`}
                    >
                        <button
                            onClick={onClose}
                    ...
                    {/* Content — no overflow constraints, flows naturally */}
